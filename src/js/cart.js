...
function cartItemTemplate(item) {
  ...
  <><a href="#" class="cart-card__image">
			...
			</a><p class="cart-card__color">${item.Colors && item.Colors[0] ? item.Colors[0].ColorName : "N/A"}</p><p class="cart-card__quantity">qty: 1</p><p class="cart-card__price">$${item.FinalPrice || "N/A"}</p></>
</li>`;
